...
workflow chip {
    ...
    call bowtie2 as align_treatment {
        input:
...
task build_index {
    ...
    command {
       bowtie2-build --large-index --threads ~{threads} ~{fasta} ~{name}
    }

    runtime {
       docker: "biocontainers/bowtie2@sha256:74f40a57768c310b504c14278d7288b196874856b9d92dc44d1b5c9bdadde439"
       maxRetries: 2
     }
